...
const Recipe = () => {
  ...
  const { increment, decrement, reset, isLoggedIn } =
  ...
  return (
    <>
      ...
      {isLoggedIn && <button onClick={increment}>RecipeIncrement</button>}
      {isLoggedIn && <button onClick={decrement}>RecipeDecrement</button>}
